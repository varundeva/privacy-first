...
// RIPEMD160 usually separate import if needed, but SHAs are core.

interface ShaGeneratorProps {
    title: string;
    description: string;
    features?: string[];
    useCases?: string[];
...
export function ShaGenerator({ title, description, features, useCases, faq }: ShaGeneratorProps) {
        ...
        <div className="min-h-screen bg-background flex flex-col">
            ...
            <main className="flex-1 mx-auto max-w-4xl px-4 py-8 sm:px-6 w-full space-y-8">
                <Card className="p-6 space-y-6">
                    ...
                    {/* Options */}
                    <div className="flex flex-wrap gap-6 p-4 border rounded-lg bg-muted/20 items-center">
                        <div className="flex items-center gap-2">
                            <div className="p-2 bg-primary/10 text-primary rounded-lg">
                                <Settings2 className="h-4 w-4" />
                            </div>
                            <span className="font-semibold text-sm">Hash Options</span>
                        </div>

                        <div className="flex items-center gap-2">
                            <Label htmlFor="variant">Algorithm</Label>
                            <Select value={variant} onValueChange={setVariant}>
                                <SelectTrigger className="w-[140px]" id="variant">
