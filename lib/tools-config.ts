...
export const toolsConfig: Tool[] = [
  ...
  // PDF Watermark
  {
    ...
    longDescription: 'Free online PDF watermark tool. Add custom text or image watermarks to your PDF files. Control position, opacity, and size. Perfect for branding, marking drafts, or protecting documents. All processing in your browser.',
    keywords: ['pdf watermark', 'add watermark to pdf', 'pdf stamp', 'watermark pdf online', 'pdf branding', 'text watermark pdf'],
    icon: 'Droplets',
    acceptedFormats: ['.pdf'],
    maxFileSize: 100,
    seo: {
      title: 'Add Watermark to PDF - Text & Image Watermarks | Free Online Tool',
      metaDescription: 'Add watermarks to PDF files online for free. Insert text or image watermarks with custom positioning and opacity. 100% private browser processing.',
      h1: 'Add Watermark to PDF Documents',
      features: [
      ...
      faq: [
        {
          ...
          answer: 'Yes! You can add both text watermarks and image watermarks (PNG or JPEG) to your PDF documents.',
        },
        {
          question: 'Can I control watermark opacity?',
          answer: 'Yes, you can adjust the opacity from 5% to 100% to make the watermark subtle or prominent.',
        },
        {
          question: 'Where can I position the watermark?',
          answer: 'Choose from 8 positions: center, diagonal, corners, or edge centers. Diagonal is great for draft stamps.',
        },
        {
          question: 'Is my PDF secure?',
          answer: 'Yes! Your PDF is processed entirely in your browser. No files are ever uploaded to any server.',
        },
      ],
    },
  },
  // PDF Delete Pages
  {
    ...
    longDescription: 'Free online tool to delete pages from PDF files. Select and remove unwanted pages with visual previews. Easy-to-use interface with thumbnail previews. All processing happens locally in your browser.',
    keywords: ['delete pdf pages', 'remove pages from pdf', 'pdf page remover', 'extract pdf pages', 'pdf editor remove pages'],
    icon: 'Trash2',
    acceptedFormats: ['.pdf'],
    maxFileSize: 100,
    seo: {
      title: 'Delete PDF Pages - Remove Pages from PDF | Free Online Tool',
      metaDescription: 'Delete pages from PDF files online for free. Visual page selection with thumbnails. Remove unwanted pages easily. 100% private browser processing.',
      h1: 'Delete Pages from PDF Documents',
      features: [
        'Visual page thumbnails',
      ...
      faq: [
        {
          ...
          answer: 'Yes! Click on multiple pages to select them, then delete all selected pages with one click.',
        },
        {
          question: 'Can I undo the deletion?',
          answer: 'The original file is not modified. You download a new PDF with the selected pages removed. Keep your original as backup.',
        },
        {
          question: 'Is there a page limit?',
          answer: 'You can delete pages from PDFs with up to 100MB in size. Very large documents process directly in your browser.',
        },
        {
          question: 'Is my PDF secure?',
          answer: 'Yes! Your PDF never leaves your device. All processing happens locally in your browser.',
        },
      ],
    },
  },
  // PDF to Text
  {
    ...
    longDescription: 'Free online PDF to text converter. Extract all text content from PDF documents. Get word count, character count, and page-by-page text. Download as TXT file or copy to clipboard. Works entirely in your browser.',
    keywords: ['pdf to text', 'extract text from pdf', 'pdf text extractor', 'convert pdf to txt', 'pdf to plain text'],
    icon: 'FileText',
    acceptedFormats: ['.pdf'],
    maxFileSize: 100,
    seo: {
      title: 'PDF to Text - Extract Text from PDF | Free Online Converter',
      metaDescription: 'Extract text from PDF files online for free. Convert PDF to plain text with word and character count. Download as TXT. 100% private browser processing.',
      ...
      useCases: [
        ...
        'Convert PDFs for analysis',
        'Make content searchable',
      ],
      faq: [
        {
          question: 'Does it work with scanned PDFs?',
          answer: 'This tool extracts text-based content. For scanned PDFs (images), you would need OCR which requires server processing.',
        },
        {
          question: 'Is formatting preserved?',
          answer: 'Plain text is extracted without formatting. This is ideal for copying content into other applications.',
        },
        {
          question: 'Can I extract text from specific pages?',
          answer: 'Currently, text is extracted from all pages. You can then select and copy the portions you need.',
        },
        {
          question: 'Is my PDF secure?',
          answer: 'Yes! Your PDF is processed entirely in your browser. No files are uploaded to any server.',
  ...
  // Images to PDF
  {
    ...
    longDescription: 'Free online image to PDF converter. Combine JPG, PNG, WebP, and other images into a single PDF document. Drag to reorder, choose page size and orientation. Perfect for creating photo albums, portfolios, or documents. All processing in your browser.',
    keywords: ['images to pdf', 'jpg to pdf', 'png to pdf', 'combine images to pdf', 'photo to pdf', 'image converter pdf'],
    icon: 'Images',
    acceptedFormats: ['.jpg', '.jpeg', '.png', '.webp', '.gif', '.bmp'],
    maxFileSize: 50,
    seo: {
      title: 'Images to PDF - Combine Photos into PDF | Free Online Converter',
      metaDescription: 'Convert images to PDF online for free. Combine multiple JPG, PNG, WebP photos into a single PDF. Drag to reorder. 100% private browser processing.',
      h1: 'Convert Images to PDF Document',
      features: [
      ...
      useCases: [
        ...
        'Package images for sharing',
      ],
      faq: [
        {
          question: 'What image formats are supported?',
          answer: 'We support JPG, JPEG, PNG, WebP, GIF, and BMP image formats.',
        },
        {
          question: 'Can I reorder the images?',
          answer: 'Yes! Drag and drop images to arrange them in your preferred order before creating the PDF.',
        },
        {
          question: 'What page sizes are available?',
          answer: 'Choose A4, US Letter, Fit to Image (maintains aspect ratio), or Original Size (page matches image dimensions).',
        },
        {
          question: 'Is my data secure?',
          answer: 'Yes! All images are processed entirely in your browser. Nothing is uploaded to any server.',
        },
      ],
    },
  },
  // PDF Grayscale
  {
    ...
    category: 'pdf',
    categoryLabel: 'PDF Tools',
    description: 'Convert colored PDF documents to black and white',
    longDescription: 'Free online PDF grayscale converter. Convert colored PDF documents to black and white. Reduce file size and prepare for printing. Adjustable quality settings. All processing happens locally in your browser.',
    keywords: ['pdf grayscale', 'pdf to black and white', 'convert pdf grayscale', 'pdf color to bw', 'remove color from pdf'],
    icon: 'Palette',
    acceptedFormats: ['.pdf'],
    maxFileSize: 100,
    seo: {
      title: 'PDF to Grayscale - Convert PDF to Black and White | Free Online',
      metaDescription: 'Convert PDF to grayscale online for free. Remove colors for black and white printing. Reduce file size. 100% private browser processing.',
      ...
      faq: [
        {
          ...
          answer: 'Yes! We use a luminance-based conversion that preserves contrast and keeps text perfectly readable.',
        },
        {
          question: 'Does it reduce file size?',
          answer: 'Generally yes, as grayscale images require less data than color images. Results vary by document.',
        },
        {
          question: 'Can I adjust the output quality?',
          answer: 'Yes, you can adjust the quality from 50% to 100%. Higher quality means larger file size.',
        },
        {
          question: 'Is my PDF secure?',
          answer: 'Yes! Your PDF is processed entirely in your browser. No files are ever uploaded to any server.',
  ...
  // PDF Sign
  {
    ...
    category: 'pdf',
    categoryLabel: 'PDF Tools',
    description: 'Add signature images to PDF documents',
    longDescription: 'Free online PDF signing tool. Add your signature image to PDF documents. Position anywhere on the page, adjust size, and apply to single or all pages. Perfect for contracts, forms, and official documents. All processing in your browser.',
    keywords: ['sign pdf', 'add signature to pdf', 'pdf signature', 'electronic signature pdf', 'esign pdf online'],
    icon: 'PenTool',
    acceptedFormats: ['.pdf'],
    maxFileSize: 100,
    seo: {
      title: 'Sign PDF - Add Signature to PDF | Free Online Tool',
      metaDescription: 'Add signature to PDF online for free. Upload your signature image and place it on documents. Adjust size and position. 100% private browser processing.',
      h1: 'Add Signature to PDF Documents',
      features: [
      ...
      faq: [
        {
          ...
          answer: 'You can use PNG or JPEG images. PNG with transparent background works best for professional results.',
        },
        {
          question: 'Can I sign multiple pages?',
          answer: 'Yes! Choose to add your signature to just the first page or apply it to all pages in the document.',
        },
        {
          question: 'Is this a legal electronic signature?',
          answer: 'This adds an image of your signature. For legally binding signatures, consider services like DocuSign or Adobe Sign.',
        },
        {
          question: 'Is my document secure?',
          answer: 'Yes! Your PDF and signature are processed entirely in your browser. Nothing is uploaded to any server.',
        },
      ],
    },
  },
  // PDF Header Footer
  {
    ...
    category: 'pdf',
    categoryLabel: 'PDF Tools',
    description: 'Add headers and footers to PDF documents',
    longDescription: 'Free online PDF header and footer tool. Add custom headers and footers with page numbers to your PDF documents. Position text left, center, or right. Skip title pages. All processing happens locally in your browser.',
    keywords: ['pdf header footer', 'add page numbers pdf', 'pdf footer', 'pdf header', 'page number pdf'],
    icon: 'AlignCenter',
    acceptedFormats: ['.pdf'],
    maxFileSize: 100,
    seo: {
      title: 'Add Header & Footer to PDF - Page Numbers | Free Online Tool',
      metaDescription: 'Add headers and footers to PDF online for free. Include page numbers, custom text, and positioning options. 100% private browser processing.',
      ...
      faq: [
        {
          ...
          answer: 'Choose from simple numbers (1, 2, 3), "Page 1", "1 of 10", or "Page 1 of 10" formats.',
        },
        {
          question: 'Can I skip the first page?',
          answer: 'Yes! Enable the "Skip first page" option to exclude title or cover pages from headers/footers.',
        },
        {
          question: 'Can I add both header and footer?',
          answer: 'Absolutely! Add a header, footer, or both with independent text, positioning, and page numbers.',
        },
        {
          question: 'Is my PDF secure?',
          answer: 'Yes! Your PDF is processed entirely in your browser. No files are ever uploaded to any server.',
  ...
  // PDF Flatten
  {
    ...
    category: 'pdf',
    categoryLabel: 'PDF Tools',
    description: 'Flatten PDF form fields and convert to static content',
    longDescription: 'Free online PDF flattening tool. Convert interactive form fields into static content. Make filled forms uneditable, reduce file size, and ensure consistent appearance. All processing happens locally in your browser.',
    keywords: ['flatten pdf', 'pdf form flatten', 'lock pdf forms', 'make pdf uneditable', 'pdf static content'],
    icon: 'Layers',
    acceptedFormats: ['.pdf'],
    maxFileSize: 100,
    seo: {
      title: 'Flatten PDF - Lock Form Fields | Free Online Tool',
      metaDescription: 'Flatten PDF forms online for free. Convert form fields to static content. Make PDFs uneditable and reduce file size. 100% private browser processing.',
      h1: 'Flatten PDF Form Fields',
      features: [
        'Convert forms to static',
        'Lock field values',
        'Reduce file size',
      ...
      faq: [
        {
          question: 'What does flattening do?',
          answer: 'Flattening converts interactive form fields (text boxes, checkboxes, dropdowns) into static, uneditable content.',
        },
        {
          question: 'Can I unflatten a PDF?',
          answer: 'No, flattening is permanent. The original form structure is removed. Always keep a backup of your original file.',
        },
        {
          question: 'Will my content be affected?',
          answer: 'The visible content stays exactly the same. Only the interactive elements are converted to static content.',
        },
        {
          question: 'Is my PDF secure?',
          answer: 'Yes! Your PDF is processed entirely in your browser. No files are ever uploaded to any server.',
  ...
  // PDF Crop
  {
    ...
    category: 'pdf',
    categoryLabel: 'PDF Tools',
    description: 'Trim margins and borders from PDF pages',
    longDescription: 'Free online PDF cropping tool. Remove unwanted margins and borders from PDF pages. Uniform or individual side cropping. Visual preview of crop area. All processing happens locally in your browser.',
    keywords: ['crop pdf', 'trim pdf margins', 'remove pdf borders', 'pdf page cropper', 'resize pdf pages'],
    icon: 'Crop',
    acceptedFormats: ['.pdf'],
    maxFileSize: 100,
    seo: {
      title: 'Crop PDF Pages - Trim Margins | Free Online Tool',
      metaDescription: 'Crop PDF pages online for free. Remove unwanted margins and borders. Uniform or custom cropping options. 100% private browser processing.',
      h1: 'Crop PDF Page Margins',
      features: [
        'Uniform cropping',
      ...
      faq: [
        {
          ...
          answer: 'Crop values are in points (1 inch = 72 points). A value of 36 removes half an inch from that side.',
        },
        {
          question: 'Can I crop different amounts from each side?',
          answer: 'Yes! Choose "Custom Crop" to set different values for top, bottom, left, and right sides.',
        },
        {
          question: 'Will it crop all pages?',
          answer: 'Yes, the crop settings are applied to all pages in the document uniformly.',
        },
        {
          question: 'Is my PDF secure?',
          answer: 'Yes! Your PDF is processed entirely in your browser. No files are ever uploaded to any server.',
  ...
  },
  {
    ...
    slug: 'json-comparison',
    category: 'json',
    categoryLabel: 'JSON Tools',
    description: 'Compare two JSON objects and highlight differences',
    longDescription: 'Free online JSON comparison tool. Compare two JSON objects side-by-side with detailed diff highlighting. See additions, deletions, and modifications instantly. Perfect for API response comparison, configuration file validation, and debugging JSON changes.',
    keywords: ['json comparison', 'json diff', 'json compare', 'compare json', 'json difference', 'side by side comparison', 'json comparison tool'],
    icon: 'GitCompare',
    acceptedFormats: ['.json', '.txt'],
    maxFileSize: 10,
    seo: {
      title: 'JSON Comparison Tool - Compare JSON Objects Side-by-Side | Free Online',
      metaDescription: 'Compare two JSON objects online for free. Side-by-side diff with highlighted changes. See additions, deletions, and modifications. 100% private browser processing.',
      h1: 'JSON Comparison & Diff Tool',
      features: [
        'Side-by-side JSON comparison',
        'Flattened key-by-key diff view',
        'Highlight additions/deletions/modifications',
        'Change statistics and summary',
        'JSON validation with error reporting',
        'Deep object comparison with nested key handling',
        'One-click copy functionality',
        '100% private & secure',
      ],
      useCases: [
        'Compare API responses and schemas',
        'Validate configuration file changes',
        'Debug JSON data updates',
        'Review API contract changes',
        'Compare before/after database exports',
        'Verify JSON migration changes',
        'Quality assurance and testing',
      ],
      faq: [
        {
          question: 'How does JSON comparison differ from text comparison?',
          answer: 'JSON comparison parses objects and compares keys and values, so structural changes are clearly highlighted. Text comparison line-by-line, which can obscure JSON changes due to formatting differences. JSON comparison handles nested objects and arrays intelligently.',
        },
        {
          question: 'How are nested objects handled?',
          answer: 'Nested objects are flattened using dot notation (e.g., "user.address.city"). This makes it easy to see exactly which fields have changed, even deeply nested ones.',
        },
        {
          question: 'What do the statistics mean?',
          answer: 'New Keys: Keys present in the modified JSON only. Removed Keys: Keys present in the original JSON only. Modified: Existing keys with changed values. Unchanged: Keys with the same value.',
        },
        {
          question: 'Can I compare empty or null objects?',
          answer: 'Yes, the tool handles null values, empty objects, and arrays correctly. This is useful for detecting when fields are removed or nullified.',
        },
        {
          question: 'Is my JSON data secure?',
          answer: 'Yes! All comparison happens in your browser. Your JSON is never uploaded to any server, ensuring complete data privacy.',
        },
        {
          question: 'Can I compare large JSON files?',
          answer: 'Yes, the tool supports files up to 10MB. Very large files may be slower depending on your device, since all processing happens locally in your browser.',
        },
      ],
    },
  },
